...
toplot[days.adjusted>0 & days.adjusted<14, event:= " 1st phase \n(days 0 - 14)"]
toplot[days.adjusted>15 & days.adjusted<29, event:= "2nd phase \n(days 15 - 29)"]
toplot[days.adjusted>30 & days.adjusted<44, event:= "3rd phase \n(days 30 - 44)"]
