---
title: "NO.N2O ( 1st : total ) priming differences . Approaches: Non-parametric and parametric (no transformation; no fert)"
...
```{r}
fit <- lm(NO.N2O.1.123 ~  precipitation + tillage, data=data)
fit.aov <- aov(NO.N2O.1.123 ~  precipitation + tillage, data=data)
fit.aov.int <- aov(NO.N2O.1.123 ~ ( precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(NO.N2O.1.123 ~ precipitation + tillage, data=data)
fit2 <- lm(NO.N2O.1.123 ~  tillage, data=data)
fit3 <- lm(NO.N2O.1.123 ~  precipitation, data=data)

fit.int <- lm(NO.N2O.1.123 ~ ( precipitation + tillage)^2, data=data)
...
```{r}
fit.p <- lmp(NO.N2O.1.123 ~  precipitation + tillage, data=data)
fit.aovp <- aovp(NO.N2O.1.123 ~  precipitation + tillage, data=data)
fit.aovp.int <- aovp(NO.N2O.1.123 ~ ( precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(NO.N2O.1.123 ~ precipitation + tillage, data=data)
fit2.p <- lmp(NO.N2O.1.123 ~  tillage, data=data)
fit3.p <- lmp(NO.N2O.1.123 ~  precipitation, data=data)

fit.int.p <- lmp(NO.N2O.1.123 ~ ( precipitation + tillage)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(NO.N2O.1.123 ~  precipitation + tillage, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.N2O.1.123 ~  precipitation + tillage, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.1.123 ~  precipitation + tillage, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.1.123 ~  precipitation + tillage, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.N2O.1.123 ~  precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(NO.N2O.1.123 ~  precipitation + tillage, data=data)
