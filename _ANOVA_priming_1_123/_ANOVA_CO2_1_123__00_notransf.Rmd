---
title: "CO2 ( 1st : total ) priming differences . Approaches: Non-parametric and parametric (no transformation)"
...
par(mfrow=c(1,4))
with(data, boxplot(CO2.1.123 ~ fertilization, main = "fertilization"))
with(data, boxplot(CO2.1.123 ~ precipitation, main = "precipitation"))
with(data, boxplot(CO2.1.123 ~ tillage, main = "tillage"))
with(data, boxplot(CO2.1.123 ~ incubation, main = "incubation"))


par(mfrow=c(1,4))
ggplot(data=data, aes(x=fertilization, y=CO2.1.123)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=precipitation, y=CO2.1.123)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=tillage, y=CO2.1.123)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=incubation, y=CO2.1.123)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
...
```{r}
fit <- lm(CO2.1.123 ~ fertilization + precipitation + tillage, data=data)
fit.aov <- aov(CO2.1.123 ~ fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(CO2.1.123 ~ (fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(CO2.1.123 ~ precipitation + tillage, data=data)
fit2 <- lm(CO2.1.123 ~ fertilization + tillage, data=data)
fit3 <- lm(CO2.1.123 ~ fertilization + precipitation, data=data)

fit.int <- lm(CO2.1.123 ~ (fertilization + precipitation + tillage)^2, data=data)
...
```{r}
fit.p <- lmp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data)
fit.aovp <- aovp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data)
fit.aovp.int <- aovp(CO2.1.123 ~ (fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(CO2.1.123 ~ precipitation + tillage, data=data)
fit2.p <- lmp(CO2.1.123 ~ fertilization + tillage, data=data)
fit3.p <- lmp(CO2.1.123 ~ fertilization + precipitation, data=data)

fit.int.p <- lmp(CO2.1.123 ~ (fertilization + precipitation + tillage)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(CO2.1.123 ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(CO2.1.123 ~ fertilization + precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
# myoutliers <- c(68,54)
# data[myoutliers, .(id, CO2.1.123, CO2.1.3, CO2.1.123, CO2.1.3)]
# 
...
summary(powerTransform(data[,CO2.1.123]))
```
...
### linearity
################################################################################
# boxTidwell(CO2.1.123 ~ fertilization + precipitation + tillage, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(CO2.1.123 ~ (precipitation + tillage + fertilization), data=data, nbest=4)
...
```{r, echo=F}
# precipitation
results.rain <- W.MW.oneway(CO2.1.123 ~ precipitation, data, n=my.n)
summary(results.rain)
plot(results.rain)

# tillage
results.tillage <- W.MW.oneway(CO2.1.123 ~ tillage, data, n=my.n)
summary(results.tillage)
plot(results.tillage)

# fert
results.fert <- W.MW.oneway(CO2.1.123 ~ fertilization, data, n=my.n)
...
```{r, echo=F}
# precipitation
results.rain <- PToneway(CO2.1.123 ~ precipitation, data, n=my.n)
summary.oneway(results.rain)

# tillage
results.till <- PToneway(CO2.1.123 ~ tillage, data, n=my.n)
summary.oneway(results.till)

# fert
results.fert <- PToneway(CO2.1.123 ~ fertilization, data, n=my.n)
