---
title: "NO ( 1st : total ) priming differences . Approaches: Non-parametric and parametric (no transformation; no tillage)"
...
```{r}
fit <- lm(NO.1.123 ~ fertilization + precipitation, data=data)
fit.aov <- aov(NO.1.123 ~ fertilization + precipitation, data=data)
fit.aov.int <- aov(NO.1.123 ~ (fertilization + precipitation)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(NO.1.123 ~ precipitation, data=data)
fit2 <- lm(NO.1.123 ~ fertilization, data=data)
fit3 <- lm(NO.1.123 ~ fertilization + precipitation, data=data)

fit.int <- lm(NO.1.123 ~ (fertilization + precipitation)^2, data=data)
...
```{r}
fit.p <- lmp(NO.1.123 ~ fertilization + precipitation, data=data)
fit.aovp <- aovp(NO.1.123 ~ fertilization + precipitation, data=data)
fit.aovp.int <- aovp(NO.1.123 ~ (fertilization + precipitation)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(NO.1.123 ~ precipitation, data=data)
fit2.p <- lmp(NO.1.123 ~ fertilization, data=data)
fit3.p <- lmp(NO.1.123 ~ fertilization + precipitation, data=data)

fit.int.p <- lmp(NO.1.123 ~ (fertilization + precipitation)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(NO.1.123 ~ fertilization + precipitation, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.1.123 ~ fertilization + precipitation, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.1.123 ~ fertilization + precipitation, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.1.123 ~ fertilization + precipitation, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.1.123 ~ fertilization + precipitation, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(NO.1.123 ~ fertilization + precipitation, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(NO.1.123 ~ (precipitation + fertilization), data=data, nbest=4)
